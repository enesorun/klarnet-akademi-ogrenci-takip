        ...
        >
          <AccordionTrigger className="hover:no-underline py-6">
            <div className="flex items-center space-x-3">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">{filteredAktif.length} öğrenci</p>
              </div>
            </div>
          </AccordionTrigger>
          <AccordionContent className="pb-6">
            {filteredAktif.length === 0 ? (
              ...
              renderStudentList(filteredAktif)
            )}
          </AccordionContent>
        </AccordionItem>
          ...
          <AccordionTrigger className="hover:no-underline py-6">
            <div className="flex items-center space-x-3">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">{filteredAraVerdi.length} öğrenci</p>
              </div>
            </div>
          </AccordionTrigger>
          <AccordionContent className="pb-6">
